...
<?php isset( $_GET[ 'ad_show' ] ) ? $safe = Show_ad_for_edit () : ''; ?>

<h2> <?php echo ( isset( $_GET[ 'ad_show' ] ) ? 'Edit' : 'Adding' ).' ad'; ?> </h2>   
    <form action = "<?php echo( isset( $_GET[ 'ad_show' ] ) ? 'index7_2.php?edit_ad='.intval( $_GET[ 'ad_key' ] ).'' : 'index7_2.php' ); ?>" method = "POST">
        <table> 
            <tr>
                <td> Name </td> 
...
<?php if ( filesize( 'Ads_data_base_7_2.php' ) !== 0 ): ?>
